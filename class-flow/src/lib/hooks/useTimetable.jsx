...
//  */
// const useTimetableFilterGettter = () => {
...
//       const fetchedData = await getTimetableFilters();
...
//       }
//     } catch (err) {
//       console.error('Failed to fetch timeable filters:', err);
...
// export default useTimetableFilterGettter;
